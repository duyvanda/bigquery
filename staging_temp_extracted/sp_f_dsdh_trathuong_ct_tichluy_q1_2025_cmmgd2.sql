-- ==========================================================================
-- Routine Name : sp_f_dsdh_trathuong_ct_tichluy_q1_2025_cmmgd2
-- Routine Type : PROCEDURE
-- Dataset      : spatial-vision-343005.staging_temp
-- Created      : 2025-03-03 03:29:10.283000+00:00
-- Last Altered : 2025-03-03 03:29:10.283000+00:00
-- Extracted At : 2026-08-06 13:45:04
-- ==========================================================================

CREATE PROCEDURE `spatial-vision-343005`.staging_temp.sp_f_dsdh_trathuong_ct_tichluy_q1_2025_cmmgd2()
BEGIN

-- TRUNCATE TABLE staging_temp.f_dsdh_trathuong_ct_tichluy_temp;
CREATE TEMP TABLE `f_dsdh_trathuong_ct_tichluy_temp_q1_2025_cmmgd2`
...
WHERE
    date(so.crtd_datetime) >= '2025-01-01' and date(so.crtd_datetime) <= '2025-03-31'
    AND ordertype = 'NP'
    AND status = 'C'
    AND remark LIKE '%Kênh PCL - MKT@24HCP3007%'
)
, manual_input as(
...
where a.inserted_at >= '2025-02-24 00:00:00 UTC'
and a.inserted_at <= '2025-02-25 00:00:00 UTC'
...
Create or replace table `warehouse.f_dsdh_trathuong_ct_tichluy_q1_2025_cmmgd2`

copy `f_dsdh_trathuong_ct_tichluy_temp_q1_2025_cmmgd2`;
END;
