-- ==========================================================================
-- Routine Name : sp_view_theo_trung_bay_decal
-- Routine Type : PROCEDURE
-- Dataset      : spatial-vision-343005.staging_temp
-- Created      : 2026-05-18 03:06:26.481000+00:00
-- Last Altered : 2026-05-18 03:06:26.481000+00:00
-- Extracted At : 2026-08-06 13:45:04
-- ==========================================================================

CREATE PROCEDURE `spatial-vision-343005`.staging_temp.sp_view_theo_trung_bay_decal()
BEGIN
  TRUNCATE TABLE staging_temp.f_kh_thamgia_trungbay_decal_temp;

 --INSERT INTO staging_temp.f_kh_thamgia_trungbay_decal_temp(
Create or replace table staging_temp.

f_kh_thamgia_trungbay_decal_temp
as
...
Case when b.ngay_thu_hoi is not null then 'Ký tay'
...
Create or replace table `warehouse.view_theo_trung_bay_decal`
