-- ==========================================================================
-- Routine Name : api_khach_hang_chua_ps_dh_theo_crs
-- Routine Type : PROCEDURE
-- Dataset      : spatial-vision-343005.staging_temp
-- Created      : 2025-12-01 03:57:30.594000+00:00
-- Last Altered : 2025-12-01 03:57:30.594000+00:00
-- Extracted At : 2026-08-06 13:45:04
-- ==========================================================================

CREATE PROCEDURE `spatial-vision-343005`.staging_temp.api_khach_hang_chua_ps_dh_theo_crs(p_ma_crs STRING)
OPTIONS(
  strict_mode=false)
BEGIN
