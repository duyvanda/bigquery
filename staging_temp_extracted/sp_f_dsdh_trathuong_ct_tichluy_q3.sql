-- ==========================================================================
-- Routine Name : sp_f_dsdh_trathuong_ct_tichluy_q3
-- Routine Type : PROCEDURE
-- Dataset      : spatial-vision-343005.staging_temp
-- Created      : 2024-12-30 06:58:19.694000+00:00
-- Last Altered : 2024-12-30 06:58:19.694000+00:00
-- Extracted At : 2026-08-06 13:45:04
-- ==========================================================================

CREATE PROCEDURE `spatial-vision-343005`.staging_temp.sp_f_dsdh_trathuong_ct_tichluy_q3()
BEGIN

-- TRUNCATE TABLE staging_temp.f_dsdh_trathuong_ct_tichluy_temp;
CREATE TEMP TABLE `f_dsdh_trathuong_ct_tichluy_temp_q3`
...
WHERE
    ordertype = 'NP'
    -- AND date(crtd_datetime) >= '2024-10-01'
    -- AND date(crtd_datetime) <= '2024-11-19'
    AND status = 'C'
    AND (
        ...
        remark LIKE '%MKT@24MTP3057%'
    )
    AND (remark LIKE '%Q3/24%' or remark LIKE '%3/2024%')
)
, manual_input as(

SELECT case
when chuongtrinh = 'Decal Q3/24' then 'MKT@24MTP2031'
when chuongtrinh = 'Ebysta Q3/24' then 'MKT@24MTP2029'
when chuongtrinh = 'Sticker Lá Đôi Q3/24' then 'MKT@24MTP2030'
when chuongtrinh = 'Bình Ổn Giá Q3/24' then 'MKT@24MTP3018'
when chuongtrinh = 'Tích lũy XO Q3/24' then 'MKT@24MTP3057'
...
Create or replace table `warehouse.f_dsdh_trathuong_ct_tichluy_q3`

copy `f_dsdh_trathuong_ct_tichluy_temp_q3`;
END;
