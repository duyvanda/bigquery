-- ==========================================================================
-- Routine Name : sp_f_thoathuanmuaban_dachot_tp
-- Routine Type : PROCEDURE
-- Dataset      : spatial-vision-343005.staging_temp
-- Created      : 2024-11-13 02:33:11.420000+00:00
-- Last Altered : 2024-11-13 02:33:11.420000+00:00
-- Extracted At : 2026-08-06 13:45:04
-- ==========================================================================

CREATE PROCEDURE `spatial-vision-343005`.staging_temp.sp_f_thoathuanmuaban_dachot_tp()
BEGIN
  TRUNCATE TABLE staging_temp.f_thoathuanmuaban_dachot_tp_temp;

 INSERT INTO staging_temp.f_thoathuanmuaban_dachot_tp_temp(

-- Create table staging_temp.f_thoathuanmuaban_dachot_tp_temp
-- as
with
tichluy_dachot as (
  select
...
Create or replace table `warehouse.f_thoathuanmuaban_dachot_tp`

copy `staging_temp.f_thoathuanmuaban_dachot_tp_temp`;
