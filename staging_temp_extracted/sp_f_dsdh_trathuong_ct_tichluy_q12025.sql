-- ==========================================================================
-- Routine Name : sp_f_dsdh_trathuong_ct_tichluy_q12025
-- Routine Type : PROCEDURE
-- Dataset      : spatial-vision-343005.staging_temp
-- Created      : 2025-07-24 07:45:55.244000+00:00
-- Last Altered : 2025-07-24 07:45:55.244000+00:00
-- Extracted At : 2026-08-06 13:45:04
-- ==========================================================================

CREATE PROCEDURE `spatial-vision-343005`.staging_temp.sp_f_dsdh_trathuong_ct_tichluy_q12025()
BEGIN

-- TRUNCATE TABLE staging_temp.f_dsdh_trathuong_ct_tichluy_temp;
CREATE TEMP TABLE `f_dsdh_trathuong_ct_tichluy_temp_q12025`
...
WHERE
    ...
    (
    CASE
    WHEN remark LIKE '%MKT@25MTP2007%' AND remark LIKE '%Q1/25%' then true
    WHEN remark LIKE '%MKT@25MTP2006%' AND remark LIKE '%Q1/25%' then true
    WHEN remark LIKE '%MKT@25MTP2008%' AND remark LIKE '%Q1/25%' then true
    else false
    END
    )

    -- Trả phí CTTB khung Ebysta Q1/25 theo tbao SCT số 03/2025 (09CPA/2025) - kênh TP - MKT@25MTP2007
    -- Trả phí CTTB Decal Xisat Q1/25 theo tbao SCT số 02/2025 (08CPA/2025) - kênh TP - MKT@25MTP2006
    -- Trả phí CTTB Sticker lá đôi Q1/25 theo tbao SCT số 04/2025 (10CPA/2025) - kênh TP - MKT@25MTP2008
)
, manual_input as(
...
where a.inserted_at >= '2025-04-17 13:25:30 UTC'
AND a.inserted_at <= '2025-07-21 00:00:00 UTC'
...
Create or replace table `warehouse.f_dsdh_trathuong_ct_tichluy_q12025`

copy `f_dsdh_trathuong_ct_tichluy_temp_q12025`;
END;
