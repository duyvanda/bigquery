  ...
  CREATE TEMP TABLE `f_congno_hcp_crs_temp` AS (
    ...
    phanloai_nokh1 as (
      SELECT 
        ...
        Case 
          -- INS --
          when sum(a.no_xau) over (partition by a.custid) > 0 and c.max_thoigian_noxau >= 365 and channel = 'INS' and (soluong_12t = 0 or soluong_12t is null) and (e.doanhthu_12t = 0 or e.doanhthu_12t is null) then 'N1_NX >=365 ngày & Không PS Dso,Dthu 12 tháng'
          when sum(a.no_xau) over (partition by a.custid) > 0 and c.max_thoigian_noxau >= 365 and channel = 'INS' and (soluong_6t = 0 or soluong_6t is null) and (e.doanhthu_6t = 0 or e.doanhthu_6t is null) then 'N2_NX >=365 ngày & Không PS Dso,Dthu 6 tháng'
          ...
          -- CLC --
          when sum(a.no_xau) over (partition by a.custid) > 0 and c.max_thoigian_noxau >= 180 and channel = 'CLC' and (soluong_12t = 0 or soluong_12t is null) and (e.doanhthu_12t = 0 or e.doanhthu_12t is null) then 'N1_NX >=180 ngày & Không PS Dso,Dthu 12 tháng'
          when sum(a.no_xau) over (partition by a.custid) > 0 and c.max_thoigian_noxau >= 180 and channel = 'CLC' and (soluong_6t = 0 or soluong_6t is null) and (e.doanhthu_6t = 0 or e.doanhthu_6t is null) then 'N2_NX >=180 ngày & Không PS Dso,Dthu 6 tháng'
