CREATE PROCEDURE `spatial-vision-343005`.staging_temp.sp_f_nhacdon_tp_12tuan()
BEGIN 
TRUNCATE TABLE staging_temp.f_nhacdon_tp_12tuan_temp;
INSERT INTO staging_temp.f_nhacdon_tp_12tuan_temp
(


-- Create or replace table `staging_temp.f_nhacdon_tp_12tuan_temp`
-- as
...
Create or replace table `warehouse.f_nhacdon_tp_12tuan`

copy `staging_temp.f_nhacdon_tp_12tuan_temp`;
