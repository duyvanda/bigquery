CREATE PROCEDURE `spatial-vision-343005`.staging_temp.sp_f_nhacdon_pcl()
OPTIONS(
  strict_mode=false)
BEGIN 
TRUNCATE TABLE staging_temp.f_nhacdon_pcl_temp;
INSERT INTO staging_temp.f_nhacdon_pcl_temp
(
  
-- Create or replace table `staging_temp.f_nhacdon_pcl_temp`
-- as
...
Create or replace table `warehouse.f_nhacdon_pcl`

copy `staging_temp.f_nhacdon_pcl_temp`;
