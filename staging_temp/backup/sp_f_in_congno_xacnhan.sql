CREATE PROCEDURE `spatial-vision-343005`.staging_temp.sp_f_in_congno_xacnhan()
BEGIN 
 
TRUNCATE TABLE `staging_temp.f_in_congno_xacnhan_temp`;

INSERT INTO `staging_temp.f_in_congno_xacnhan_temp`

(   

-- Create or replace table staging_temp.f_in_congno_xacnhan_temp
-- partition by date(thang)
-- cluster by ma_csm,ma_mds,so_don_hang,so_hd
-- as
with 
khuvuc_mds as ( 
...
Create or replace table `warehouse.f_in_congno_xacnhan`

copy `staging_temp.f_in_congno_xacnhan_temp`;
