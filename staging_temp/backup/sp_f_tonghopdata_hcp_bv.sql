CREATE PROCEDURE `spatial-vision-343005`.staging_temp.sp_f_tonghopdata_hcp_bv(manv_p STRING, version_p STRING)
BEGIN 
...
(
  SELECT
    ...
    ifnull(c.custid,d.custid) as custid,
    ifnull(c.custname,d.custname) as custname,
    ifnull(e.custid,f.custid) as custid_bs_lambv_cocode,
