      ...
      phanloai_nokh1 as (
        SELECT
          ...
          -------------------------INS-------------
            ...
            ) then 'N1_NX >=365 ngày & Không PS Dso,Dthu 12 tháng'
            when sum(a.no_xau) over (
              partition by
                a.custid
            ) > 0
            ...
            ) then 'N2_NX >=365 ngày & Không PS Dso,Dthu 6 tháng'
            when sum(a.no_xau) over (
              partition by
                a.custid
            ) > 0
            ...
            and (
              e.doanhthu_12t = 0
              or e.doanhthu_12t is null
            ) then 'N1_NX >=180 ngày & Không PS Dso,Dthu 12 tháng'
            when sum(a.no_xau) over (
              partition by
                a.custid
            ) > 0
            ...
            and (
              e.doanhthu_6t = 0
              or e.doanhthu_6t is null
            ) then 'N2_NX >=180 ngày & Không PS Dso,Dthu 6 tháng'
            when sum(a.no_xau) over (
              partition by
                a.custid
            ) > 0
