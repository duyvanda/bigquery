CREATE PROCEDURE `spatial-vision-343005`.warehouse.api_ds_theo_khach_nhan(p_makhdms STRING, p_startdate STRING, p_enddate STRING, p_page STRING, p_limit STRING)
OPTIONS(
  strict_mode=false)
BEGIN
