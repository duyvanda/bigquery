CREATE PROCEDURE `spatial-vision-343005`.staging_temp.api_ton_kho_chinhanh_realtime(p_manv STRING, p_version STRING)
BEGIN
-- Default values
...
INSERT INTO `warehouse.f_baocao_tonkho_hangngay_realtime`
(
   -- Create or replace table `warehouse.f_baocao_tonkho_hangngay_realtime` as 
with base as (
    select
        masanpham,
        Case
...
base_tonkho as (
    ...
    where
        ...
        and manv = p_manv and version = p_version
),
