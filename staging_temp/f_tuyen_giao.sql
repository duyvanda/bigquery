CREATE PROCEDURE `spatial-vision-343005`.staging_temp.f_tuyen_giao()
OPTIONS(
  strict_mode=false)
BEGIN 
 
 TRUNCATE TABLE staging_temp.f_tuyen_giao_temp;

 INSERT INTO `staging_temp.f_tuyen_giao_temp`

( 
-- Create or replace table `staging_temp.f_tuyen_giao_temp`
-- as
...
where a.delivery_date >= '2023-07-01' and makhdms is not null -- a.slsperid in ('MR2524') and

);

Create or replace table `warehouse.f_tuyen_giao`

copy `staging_temp.f_tuyen_giao_temp`;
