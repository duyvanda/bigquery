CREATE PROCEDURE `spatial-vision-343005`.staging_temp.f_delivery_geomap_doanhso()
BEGIN 

TRUNCATE TABLE staging_temp.f_delivery_geomap_doanhso_temp;

 INSERT INTO staging_temp.f_delivery_geomap_doanhso_temp
(


-- CREATE OR REPLACE table `staging_temp.f_delivery_geomap_doanhso_temp`
-- as
...
Create or replace table `warehouse.f_delivery_geomap_doanhso`

copy `staging_temp.f_delivery_geomap_doanhso_temp`;
