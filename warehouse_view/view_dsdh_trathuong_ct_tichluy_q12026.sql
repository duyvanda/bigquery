CREATE VIEW `spatial-vision-343005.warehouse.view_dsdh_trathuong_ct_tichluy_q12026`
AS WITH 
NGAYGIAOHANG as
(
  select 
...
WHERE 
    ...
    */
    ...
    (
      CASE 
          WHEN remark LIKE '%Q1/26%' AND (
            --   remark LIKE '%MKT@25MTP3086%' OR
              remark LIKE '%MKT@26MTP2005%' OR
              remark LIKE '%MKT@26MTP2004%'
...
where 
true
AND a.inserted_at >= '2026-05-01 00:00:00 UTC'
and a.inserted_at <= '2026-06-30 00:00:00 UTC'
