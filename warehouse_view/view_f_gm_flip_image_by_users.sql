CREATE VIEW `spatial-vision-343005.warehouse.view_f_gm_flip_image_by_users`
AS SELECT
a.id_user,
a.id_customer_oa,
a.id_customer,
...
a.card_price,
a.lucky_code,
case when a.card_type_name = 'Vinafone' then 'Vinaphone' else a.card_type_name end as card_type_name,
a.times,
a.is_win,
a.is_rewarded,
a.is_finished,
...
FROM `spatial-vision-343005.staging.f_gm_flip_image_2026_by_users` a
