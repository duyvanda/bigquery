CREATE VIEW `spatial-vision-343005.warehouse.view_f_gm_puzze_image_by_users`
AS SELECT
...
FROM `spatial-vision-343005.staging.f_gm_puzze_image_by_users` a
