CREATE VIEW `spatial-vision-343005.warehouse.view_kha_nang_sanxuat_khong_biet_tru`
...
case when floor(sl_nhonhat_sx) <= 0 then 0 else floor(sl_nhonhat_sx) end as sl_nhonhat_sx,
