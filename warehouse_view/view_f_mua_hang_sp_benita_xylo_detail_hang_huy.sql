CREATE VIEW `spatial-vision-343005.warehouse.view_f_mua_hang_sp_benita_xylo_detail_hang_huy`
AS with 

sales as (
  select sodondathang,macongtycn,manv from `staging.f_sales` where masanpham ='T303102009' and ngaychungtu >='2024-10-10' and makenhkh = 'TP' group by all
),
...
phanphoi_hientai as (
  ...
  where 
  a.ordertype in ('CO','IR','LO') and b.freeitem is false and b.invtid ='T303102009' and date(a.crtd_datetime) >='2025-02-03' and a.crtd_datetime <'2025-03-31 16:00:00' and a.status not in ('E','V','X')
  group by all
),
