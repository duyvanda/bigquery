CREATE VIEW `spatial-vision-343005.warehouse.view_checking_display_criteria_mds_quy22026`
...
where date(visitdate) >= '2026-06-01' and date(visitdate) <= '2026-07-15'
...
WHERE date(a.inserted_at) >= '2026-06-22' and date(a.inserted_at) <= '2026-07-15';