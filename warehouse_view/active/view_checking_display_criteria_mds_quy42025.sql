CREATE VIEW `spatial-vision-343005.warehouse.view_checking_display_criteria_mds_quy42025`
...
where date(visitdate) >= '2025-12-01' and date(visitdate) <= '2025-12-26'
...
WHERE date(a.inserted_at) >= '2025-11-28' and date(a.inserted_at) <= '2025-12-04';