CREATE VIEW `spatial-vision-343005.warehouse.view_phan_bo_mt`
AS WITH phan_bo AS (
  SELECT * FROM `spatial-vision-343005.staging.d_phan_bo_san_pham_tp_2026` where ma_crm = 'MR2685'
)
