CREATE VIEW `spatial-vision-343005.warehouse.view_checking_display_criteria_mds_quy12025`
...
where date(visitdate) >= '2025-01-01' and date(visitdate) <= '2025-03-31'
...
WHERE date(a.inserted_at) >= '2025-01-01' and date(a.inserted_at) <= '2025-03-31'
