CREATE VIEW `spatial-vision-343005.warehouse.view_checking_display_criteria_mds_quy4`
...
where date(visitdate) >= '2024-12-02' and date(visitdate) <= '2024-12-21'
...
WHERE date(a.inserted_at) >= '2024-11-27' and date(a.inserted_at) <= '2024-12-31'
