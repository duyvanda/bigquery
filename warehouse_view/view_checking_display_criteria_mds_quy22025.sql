CREATE VIEW `spatial-vision-343005.warehouse.view_checking_display_criteria_mds_quy22025`
...
where date(visitdate) >= '2025-06-01' and date(visitdate) <= '2025-06-30'
...
WHERE date(a.inserted_at) >= '2025-04-01' and date(a.inserted_at) <= '2025-06-30'
