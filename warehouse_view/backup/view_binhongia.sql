CREATE VIEW `spatial-vision-343005.warehouse.view_binhongia`
...
pic4,
pic5,
ROW_NUMBER() OVER (PARTITION BY slsperid, custid, v.invtid ORDER BY visitdate DESC) AS row
